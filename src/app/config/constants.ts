import { Orientation, RotateDeg, TableDimension, Commands } from '../types';
...
export const COMMANDS: Commands = ['PLACE', 'MOVE', 'LEFT', 'RIGHT', 'REPORT'];

export const FACING_DIRECTIONS = Object.keys(ORIENTATION);

export const ERRORS = {
    invalidCommand: `Formato de comando inválido. Os comandos disponíveis são ${COMMANDS.join(' | ')}.`,
